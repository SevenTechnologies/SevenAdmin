...
switch(valued[i].value){
  ...
  case 'Fibre': 
   ...
   case 'Metal':
   str3+="<tr><td>"+count+"</td><td>"+valued[i].part_name+"</td><td>"+valued[i].claimed+
         "</td><td>"+valued[i].assessed+"</td><td>"+valued[i].nature_of_damage+"</td></tr>";
   ...
   str4+="<tr><td>"+count+"</td><td>"+valued[i].part_name+"</td><td>"+valued[i].claimed+
         "</td><td>"+valued[i].assessed+"</td><td>"+valued[i].nature_of_damage+"</td></tr>";
   ...
   case 'Glass':
    str5+="<tr><td>"+count+"</td><td>"+valued[i].part_name+"</td><td>"+valued[i].claimed+
         "</td><td>"+valued[i].assessed+"</td><td>"+valued[i].nature_of_damage+"</td></tr>";
      
   document.getElementById("glass").innerHTML=str5;
    count++;
   break;
    str6+="<tr><td>"+count+"</td><td>"+valued[i].part_name+"</td><td>"+valued[i].claimed+
